...
{
    public const array INTEGER_TYPES = [
        'integer',
        'tinyInteger',
        'smallInteger',
        'mediumInteger',
    ...
    public static function fromColumn(string $context, Column $column): array
    {
        ...
        if ($column->attributes() && \in_array($column->type(), ['string', 'char'], true)) {
    ...
    private static function overrideStringRuleForSpecialNames(string $name): string
    {
