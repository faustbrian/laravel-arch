...
it('returns all statements', function (): void {
    ...
    $statementRepository->add([
        'methods' => ['render'],
        'fullyQualifiedClassName' => \BombenProdukt\Arch\Statement\Inertia\RenderStatement::class,
    ]);

    $statementRepository->add([
        'methods' => ['view'],
        'fullyQualifiedClassName' => \BombenProdukt\Arch\Statement\Laravel\ViewStatement::class,
    ]);
